<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Terms.aspx.cs" Inherits="RevUp.Terms" %>
   ...
   <main class="wrap">
       ...
       <section class="container">
        ...
        <div class="container__nav">
          ...
          <asp:Button ID="Button1"  class="button" runat="server" Text="ACCEPT" OnClick="Button1_Click" />
        </div>
      </section>
